...
import { get_students_by_id_thunk, store_students_thunk } from "@/app/pages/admin/students/redux/students-thunk";
...
export default function CreateSection() {
    ...
    async function submitForm() {
        ...
        const result = await store.dispatch(
            store_students_thunk({ ...data, user_type: 3, teacher: user?.user_id }),
        );
    ...
    console.log("teachersArray", user);
    ...
    return (
        <div>
            ...
            <Drawer anchor="right" open={open} onClose={toggleDrawer(false)}>
                <Box
                    className="w-[500px] h-full flex bg-white z-50"
                    role="presentation"
                >
                    <div className="pt-20 px-3 w-full flex flex-col items-center justify-between pb-5">
                        <div className="flex flex-col gap-3 w-full">
                            ...
                            {/* <FormControl
                                ...
                                fullWidth
                            >
                                <InputLabel id="teacher-id-label">
                                    Teacher/Adviser
                                </InputLabel>
                                <Select
