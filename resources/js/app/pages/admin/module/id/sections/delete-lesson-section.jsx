...
import { delete_lesson_thunk, get_lesson_thunk } from '../../redux/lesson-thunk';
...
export default function DeleteLessonSection({ data }) {
    ...
    async function delete_data(params) {
        setLoading(true)
        try {
            await store.dispatch(delete_lesson_thunk(data.id))
